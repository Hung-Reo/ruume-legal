...
- AI tự động quét **nội dung dạng văn bản** của tin đăng để phát hiện dấu hiệu vi phạm và đánh dấu rủi ro. Công cụ tự động chỉ giữ vai trò sàng lọc và cảnh báo; **mọi quyết định phê duyệt, ẩn/gỡ hoặc từ chối đều do quản trị viên là con người quyết định cuối cùng**.
- Đội ngũ admin/trưởng khu (sub-admin) kiểm duyệt + xử lý báo cáo.
- Khi người bán **chỉnh sửa nội dung hoặc thay đổi hình ảnh** của tin đã hiển thị, tin đăng được **tự động chuyển lại trạng thái chờ duyệt** cho tới khi được phê duyệt lại.
